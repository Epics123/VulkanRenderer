...
std::unordered_set<std::string> Utils::filterExtensions(std::vector<std::string> availableExtensions, std::vector<std::string> requestedExtensions)
{
...
//	ofn.hwndOwner = glfwGetWin32Window(Application::getInstance()->getApplicationWindow()->getWindow());
...
//}
//
//std::string Utils::FileDialogs::saveFile(const char* filter)
//{
//	return std::string();
//}
