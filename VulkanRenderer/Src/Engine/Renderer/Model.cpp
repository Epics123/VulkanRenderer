...
const std::string Model::modelDir = "Src/resources/vulkan/models/";
...
Model::Model(Context& device, const Builder& builder) : device{device}
{
...
std::unique_ptr<Model> Model::createModelFromFile(Context& device, const std::string& filename)
{
	Builder builder{};
