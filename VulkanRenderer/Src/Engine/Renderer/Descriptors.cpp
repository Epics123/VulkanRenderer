...
DescriptorSetLayout::DescriptorSetLayout(Context& device, std::unordered_map<uint32_t, VkDescriptorSetLayoutBinding> bindings, bool unbound)
...
DescriptorPool::DescriptorPool(Context& device, uint32_t maxSets, VkDescriptorPoolCreateFlags poolFlags, const std::vector<VkDescriptorPoolSize>& poolSizes)
	: mDevice{ device }
{
