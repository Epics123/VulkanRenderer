...
PointLightSystem::PointLightSystem(Context& device)
	: device{ device }
{
}
...
void PointLightSystem::createPipeline(VkRenderPass renderPass)
{
	...
	pipeline = std::make_unique<Pipeline_>(device, "Src/resources/vulkan/shaders/PointLightVert.spv", "Src/resources/vulkan/shaders/PointLightFrag.spv", pipelineConfig);
}