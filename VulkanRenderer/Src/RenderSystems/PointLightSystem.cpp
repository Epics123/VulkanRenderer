...
void PointLightSystem::createPipeline(VkRenderPass renderPass)
{
	...
	pipeline = std::make_unique<Pipeline>(device, "Src/resources/vulkan/shaders/PointLightVert.spv", "Src/resources/vulkan/shaders/PointLightFrag.spv", pipelineConfig);
}