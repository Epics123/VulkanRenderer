...
WireframeSystem::WireframeSystem(Context& device)
	:RenderSystem(device)
{
...
{
	vertFilePath = "Src/resources/vulkan/shaders/WireframeVert.spv";
	fragFilePath = "Src/resources/vulkan/shaders/WireframeFrag.spv";
