...
void Renderer::updateUniformBuffer(uint32_t currentImage)
{
	...
	ubo.view = glm::lookAt(mainCamera.position, mainCamera.position + mainCamera.forward, mainCamera.up);
	ubo.proj = glm::perspective(glm::radians(mainCamera.fov), swapChainImageExtent.width / (float)swapChainImageExtent.height, 0.1f, 200.0f);
	ubo.proj[1][1] *= -1;
